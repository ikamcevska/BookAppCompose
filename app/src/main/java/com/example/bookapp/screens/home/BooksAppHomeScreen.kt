...
fun BookHomeScreen(
    ...
    Scaffold(topBar = {
        BookAppBar(title = "Book App", navController = navController )


    },
        floatingActionButton = {
            FABContent{
                navController.navigate(BooksScreens.SearchScreen.name)
            }
        ...
        Row(modifier = Modifier.align(alignment = Alignment.Start)) {
            ...
            Column {
                Icon(
                    ...
                    modifier = Modifier
                        .clickable {
                            navController.navigate(BooksScreens.StatsScreen.name)
                        }
                        .size(45.dp),
...
fun BookListArea(listOfBooks: List<MBook>,
    ...
    HorizontalScrollableComponent(addedBooks){
        navController.navigate(BooksScreens.UpdateScreen.name +"/$it")
